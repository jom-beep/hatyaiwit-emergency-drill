...
- สลับบทบาท: ผู้ประกาศ 1–5 (คิวควบคุม ตรีจักร 191 + ยืนยันยุติ 2 คน) และครูผู้รับแจ้ง (กดรับทราบ → ปลอดภัย / ต้องการช่วยเหลือ / ไม่อยู่ในพื้นที่ และเปลี่ยนสถานะได้ตลอดจนกว่าจะยุติ)
- การ์ดคำแนะนำสั้นใต้ปุ่มใหญ่ตามประเภทเหตุ (เช่น ล็อกดาวน์: เงียบ ปิดไฟ ห้ามเปิดประตู)
- มีเทมเพลต **กราดยิง / ตรีจักร 191** (ค่าเริ่มต้นของ `/demo`) พร้อมแผนผังโรงเรียนจำลอง ปักหมุดผู้รับแจ้ง เขตแดงของผู้ประกาศที่ควบคุม และคิวแอดมิน 20 วินาที รวมถึงเทมเพลต อพยพเหตุเพลิงไหม้ / แผ่นดินไหว / ล็อกดาวน์ / ภัยคุกคาม, กระดานคนที่ยังไม่ตอบตามอาคาร (คนที่กดไม่อยู่ในพื้นที่ไม่ถูกนับเป็นผู้ไม่ตอบ) และสรุปหลังซ้อม
- หมุดและเขตแดงซิงก์ข้ามแท็บผ่าน localStorage / BroadcastChannel ของโหมดสาธิต (ไม่เรียก Durable Object หรือ `/api/*` จริง) — ยุติการฝึกแล้วยังต้องยืนยัน 2 คน และจะล้างหมุดกับเขตแดงอัตโนมัติ
